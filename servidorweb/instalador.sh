...
until docker exec servidorweb-main-db-1 mysqladmin ping -hlocalhost -uroot -p1234 --silent; do
  sleep 2
done

# Ejecutar los inserts
echo "⚙️ Insertando datos por defecto en la base de datos..."
docker exec -i servidorweb-main-db-1 mysql -uroot -p1234 catalogocine <<EOF
